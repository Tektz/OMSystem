...
header("location: seller_home.php#products");
}
...
<div class="container-fluid col-sm-10">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter table-hover">
                    ...
                    <tbody>
                    <?php 
                        $result=mysqli_query($con,"select product_id, product_name, product_desc, product_price from product WHERE seller_id='$_SESSION[seller_id]'")or die ("query 2 incorrect...");
